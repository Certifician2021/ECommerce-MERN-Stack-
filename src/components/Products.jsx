      ...
      <div className="top">
        ...
        >
          {state.map((item, index) => {
            return (
              <>
                {open === index && <Product cart={cart} setCart={setCart} data={item} closeModal={setOpen} />}
                <div
                ...
                >
                  ...
                  >
                    <p style={{ paddingLeft: "20px", fontWeight: "600" }}>
                      {item.productName}
                    </p>
                    <p
                      style={{ marginRight: "15px", fontWeight: "600" }}
                    >{`Rs. ${item.productPrice}`}</p>
                  </div>
                  <button
                    onClick={(e) => {
                      cartHandler(e, item.productPrice, item.productName);
                    }}
                    style={{
                      marginLeft: "20px",
                      borderRadius: " 10px",
                      height: "35px",
                      width: "220px",
                      boxShadow: "1px solid rgba(0,0,0,0.5)",
                      border: "none",
